...
def report(
    ...
    top_k_categories : int = typer.Option(3, help="Топ категорий"),
    title : str = typer.Option("", help="Заголовок отчёта")
) -> None:
    """
    ...
    #top_k_cats = top_categories(df=df, top_k=top_k_categories)
    # 2. Качество в целом
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        # вывод эвристик
        f.write(f"- Слишком много признаков : **{quality_flags['has_high_cardinality_categoricals']}**\n")
